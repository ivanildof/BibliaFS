            ...
            <header className="flex items-center justify-between gap-2 p-4 border-b bg-white/80 dark:bg-slate-900/80 backdrop-blur-md shadow-sm shrink-0 sticky top-0 z-50">
              ...
              <div className="flex items-center gap-3">
                <a
                  ...
                  className="relative inline-flex items-center gap-1.5 px-3 py-1.5 text-xs font-semibold text-white rounded-full overflow-visible cursor-pointer no-underline transition-all duration-300 hover:scale-105 hover:shadow-lg hover:shadow-purple-500/30"
                  style={{
