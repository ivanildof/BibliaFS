  ...
  return (
    <div className="min-h-screen bg-background relative overflow-hidden">
      ...
      <div className="relative z-10 max-w-4xl mx-auto py-10 px-6">
        ...
        >
            <Card className="rounded-[2.5rem] border-none bg-card shadow-xl mb-12 overflow-hidden relative group">
        ...
        {(!achievements || achievements.length === 0) && (
          <motion.div
            ...
            animate={{ opacity: 1, y: 0 }}
          >
            <Card className="rounded-[3rem] border-2 border-dashed border-border bg-card shadow-sm">
