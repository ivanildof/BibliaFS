...
import { Book, Eye, EyeOff, Loader2, ArrowLeft } from "lucide-react";
              ...
              <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
                ...
                <div className="space-y-3">
                  <Button
                    type="button"
                    variant="outline"
                    className="w-full h-11 rounded-xl font-bold text-base border-primary/10 hover:bg-muted/50 transition-all flex items-center justify-center gap-2 opacity-50 cursor-not-allowed"
                    onClick={() => {
                      toast({
                        title: "Login com Google indisponível",
                        description: "Estamos trabalhando nisso! Essa funcionalidade será liberada em breve.",
                      });
                    }}
